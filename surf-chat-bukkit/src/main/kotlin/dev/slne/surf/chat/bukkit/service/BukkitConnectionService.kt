...
class BukkitConnectionService : ConnectionService, Services.Fallback {
    ...
    override fun loadMessages() {
        joinMessage =
            pluginConfig.getString("connection.messages.join") ?: "An internal error occurred: 021"
        leaveMessage = pluginConfig.getString("connection.messages.leave")
            ?: "An internal error occurred: 022."
