...
fun CommandAPICommand.surfChatLookupHelpCommand(): CommandAPICommand = withSubcommand(
    subcommand("lookuphelp") {
        withPermission(ChatPermissions.COMMAND_SURFCHAT_LOOKUP_HELP)
